defmodule PhoenixPlayground.DonationsTest do
  use PhoenixPlayground.DataCase

  alias PhoenixPlayground.Donations

  describe "donations" do
    alias PhoenixPlayground.Donations.Donation

    import PhoenixPlayground.DonationsFixtures
    ...
    test "create_donation/1 with valid data creates a donation" do
      valid_attrs = %{item: "some item", days_until_expires: 42, emoji: "some emoji", quantity: 42}
    ...
    test "update_donation/2 with valid data updates the donation" do
      donation = donation_fixture()
      update_attrs = %{item: "some updated item", days_until_expires: 43, emoji: "some updated emoji", quantity: 43}
